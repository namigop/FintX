...
public static class ServerHandler {
    ...
    // ReSharper disable once UnusedMember.Global
    public static Task RunDuplex(string concreteService, string methodName, object requestStream, object responseStream,
        ServerCallContext context) => throw new NotImplementedException(
        "Mocks are not supported for duplex streaming. Try out FintX Enterprise instead at https://fintx.dev");

    // ReSharper disable once UnusedMember.Global
    public static Task RunServerStream(string concreteService, string methodName, object request, object responseStream,
        ServerCallContext context) => throw new NotImplementedException(
        "Mocks are not supported for server streaming. Try out FintX Enterprise instead at https://fintx.dev");

    // ReSharper disable once UnusedMember.Global
    public static async Task<object> RunUnary(string concreteService, string methodName, object request,
    ...
    public class ScriptEnv(string serviceName, ScriptEngine engine, List<TargetMethod> methods) {
        ...
        public async Task<(string, Type)> RunClientStream(string method, object requestStream,
            ServerCallContext context) {
