...
public class TreeRequestEditorViewModel : ViewModelBase, IRequestEditorViewModel {
    ...
    public void Show(object?[] parameters, List<VarDefinition> reqVars, ProjectTypes.ClientGroup clientGroup) {
        ...
        foreach (var paramInfo in methodParams) {
            ...
            //     var instance2 = TypeBuilder.fakeIt(paramInfo.ParameterType);
            ...
            var instance = hasValues
                ? parameters[counter]
                : TypeBuilder.getDefault(paramInfo.Name, paramInfo.ParameterType, true, Core.Utils.none<object>(), 0).Item2;
