...
public class MetadataEntryNode : TypeBaseNode {
    ...
    public override void Init(Dictionary<string, int> processedTypeNames) {
        ...
        // this.Title = "Item";
        // this.SubTitle = $"[{_index}]";

        //Create child nodes Key and Value that when edited will change the Key and EntryValue propertyies of this MetadataEntryNode.  This is different from how the
        //other nodes work!
