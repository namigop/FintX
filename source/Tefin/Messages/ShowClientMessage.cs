...
public class ShowClientMessage(CompileOutput output, string protoFilesOrUrl, string clientName, string? selectedDiscoveredService, string description, string[] csFiles)
    : MessageBase {
